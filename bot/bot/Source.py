...
@bot_client.on_message(filters.regex("🔗Источник"))
...
@bot_client.on_message(filters.regex("✏️Изменить ПРОДАЖА") & fsm_filter("source"))
...
@bot_client.on_message(filters.text & fsm_filter("source_change_sell"))
...
@bot_client.on_message(filters.regex("✏️Изменить АРЕНДА") & fsm_filter("source"))
...
@bot_client.on_message(filters.text & fsm_filter("source_change_rent"))
